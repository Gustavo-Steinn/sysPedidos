...
public class MunicipioController {
    ...
    public Municipio getMunicipio(@PathVariable BigInteger id) throws Exception {
    ...
    public Municipio postMunicipio(@RequestBody Municipio entity) throws Exception {
        try {
            ...
            throw new Exception("Não foi possível criar o municipio." + e.getMessage());
        }
    ...
    public String deleteMunicipio(@PathVariable BigInteger id) throws Exception{
        try {
            ...
            throw new Exception("Não foi possível excluir o município com o id informado." + e.getMessage());
        }
    }
}
